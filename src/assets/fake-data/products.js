...
const products = [
  {
    ...
    size: ["s", "m", "l", "xl"],
    description: `Mô tả sản phẩm Màu sắc sản phẩm trẻ trung, thiết kế form dáng dễ mặc.Áo có thiết kế túi 
      đựng nhỏ gọn, dễ dàng đựng các vật dụng nhỏ khác Áo siêu nhẹ, có tác dụng giữ ấm cho cơ thể, 
      chống thấm nước vào bên trong, cản gió, chống tĩnh điện tốt.Mô tả sản phẩm Màu sắc sản phẩm trẻ trung, 
      thiết kế form dáng dễ mặc.Áo có thiết kế túi đựng nhỏ gọn, dễ dàng đựng các vật dụng nhỏ khác Áo siêu nhẹ,
      có tác dụng giữ ấm cho cơ thể, chống thấm nước vào bên trong, cản gió, chống tĩnh điện tốt.Mô tả sản phẩm 
      Màu sắc sản phẩm trẻ trung, thiết kế form dáng dễ mặc.Áo có thiết kế túi đựng nhỏ gọn, dễ dàng đựng các
      vật dụng nhỏ khác Áo siêu nhẹ, có tác dụng giữ ấm cho cơ thể, chống thấm nước vào bên trong, cản gió, 
      chống tĩnh điện tốt.Mô tả sản phẩm Màu sắc sản phẩm trẻ trung, thiết kế form dáng dễ mặc.Áo có thiết 
      kế túi đựng nhỏ gọn, dễ dàng đựng các vật dụng nhỏ khác Áo siêu nhẹ, có tác dụng giữ ấm cho cơ thể, 
      chống thấm nước vào bên trong, cản gió, chống tĩnh điện tốt.Màu sắc sản phẩm trẻ trung, thiết kế form dáng dễ mặc.Áo có thiết kế túi đựng nhỏ gọn, dễ dàng đựng các
      vật dụng nhỏ khác Áo siêu nhẹ, có tác dụng giữ ấm cho cơ thể, chống thấm nước vào bên trong, cản gió, 
      chống tĩnh điện tốt.Mô tả sản phẩm Màu sắc sản phẩm trẻ trung, thiết kế form dáng dễ mặc.Áo có thiết 
      kế túi đựng nhỏ gọn, dễ dàng đựng các vật dụng nhỏ khác Áo siêu nhẹ, có tác dụng giữ ấm cho cơ thể, 
      chống thấm nước vào bên trong, cản gió, chống tĩnh điện tốt.`,
  },
  {
...
const getCartItemsDetails = (cartItems) => {
  ...
  if (cartItems.length > 0) {
    cartItems.forEach((item) => {
      res.push({
        ...item,
        product: getProductSlug(item.slug),
      });
    });
  }
  return res;
